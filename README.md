...
- `marks-preview.html` - 30 typefaces as a `D`, each at display size and at 16/24px on both
  light and dark. Kept from when the mark was a letter; useful if it ever becomes one
  again. Check any face at 16px before committing - even stroke weights survive icon
  sizes, Didone hairlines do not.
